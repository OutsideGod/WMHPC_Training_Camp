  ...
  if (((int)threadIdx.x) < 128) {
    ...
    for (int k_1 = 0; k_1 < 2; ++k_1) {
      mbarrier[k_1].wait(0);
      {
        ...
        tl::increase_descriptor_offset<int>(desc_a, (k_1 * 8192));
        tl::initialize_wgmma_descriptor<1, 256, 64>(desc_b, (&(((half_t*)B_shared)[0])));
        tl::increase_descriptor_offset<int>(desc_b, (k_1 * 8192));
    ...
    for (int i_2 = 0; i_2 < 64; ++i_2) {
      *(float2*)(C + ((((((((i_2 >> 5) * 8192) + ((((int)threadIdx.x) >> 5) * 2048)) + ((i_2 & 1) * 1024)) + (((((int)threadIdx.x) & 31) >> 2) * 128)) + (((i_2 & 31) >> 1) * 8)) + ((((int)threadIdx.x) & 3) * 2)) - 8192)) = *(float2*)(C_local + (i_2 * 2));
    }
  }
}
